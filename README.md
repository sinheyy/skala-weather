...
- [구현 내용 정리](#구현-내용-정리)
  ...
  - [5. 사이드 패널 — 계산까지 위임](#5-사이드-패널--계산까지-위임)
  ...
  - [14. 단위 변환 적용](#14-단위-변환-적용)
  - [15. Axios — 실시간 날씨 연동](#15-axios--실시간-날씨-연동)
  - [16. 추가 API — 예보 · 일출 · 관광지](#16-추가-api--예보--일출--관광지)
  - [17. 즐겨찾기 · 방문 기록](#17-즐겨찾기--방문-기록)
  - [18. UI 라이브러리 (`Element Plus`)](#18-ui-라이브러리-element-plus)
- [트러블슈팅](#트러블슈팅)
